<template>
    ...
    <div class="columns is-gapless is-centered is-vcentered">
        <div class="column is-4">
            ...
            <h4 class="subtitle is-4">Creation / Edition d'une piece.</h4>
            ...
            <form v-on:submit.prevent="save" class="ui form">
                ...
                <button v-link="{name: 'setup_rooms_listing'}" type="button" class="button is-outlined is-danger">Annuler</button>
